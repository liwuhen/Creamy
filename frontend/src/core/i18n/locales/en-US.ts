...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 Creamy, an open source super agent. With built-in and custom skills, Creamy helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Creamy. With customized skills,\nCreamy can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Creamy is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Creamy could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Creamy's official website",
    githubTooltip: "Creamy on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "Creamy on GitHub",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Creamy",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Creamy faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Creamy looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "Creamy automatically learns from your conversations in the background. These memories help Creamy understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Creamy.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Creamy only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
